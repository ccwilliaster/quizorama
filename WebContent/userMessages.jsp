...
<head>
	...
	<title><%= user.getUserName() %>'s messages</title>
</head>
<body>
	...
	<div class="container">
		<div class="jumptron">
			<% 
			out.println("<h2>" + user.getUserName() + "'s messages");
			if ( msgUpdate != null) { // if message update happened, notify user
				out.println("<br><small>" + msgUpdate + "</small>");
			} 
			out.println("</h2>");
			%>
			<ul class="nav nav-tabs">
				<%
				if ( mailType.equals("inbox") || mailType == null ) {
